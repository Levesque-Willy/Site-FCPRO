...
<body>
  ...
  <header>
    ...
    <ul>
      ...
      <li class="menu">
        <a href="../phpsite/Afficher.php" class="nav">Nos Formations</a>
        <li><a href="../phpsite/Créer_saisir.html">Ajouter</a></li>
        <li><a href="../afficherutil.php">liste utilisateur</a></li>
        <li><a href="../utilisateur.html">nouveau utilisateur</a></li>
