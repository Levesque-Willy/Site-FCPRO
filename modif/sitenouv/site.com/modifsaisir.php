...
<?php
  ...
  if ((  $ligne = mysqli_fetch_array($Resultat)) and ($donnees = mysqli_fetch_array($Resultat2)))
  {	
  ...
  echo "<pre>Formateur  : <input name=formateur      type=select value=".$donnees['Nom']."> <pre>" ;
