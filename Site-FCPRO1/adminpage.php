...
<body>
  ...
  <header>
    ...
    <ul>
      ...
      <li><a href="https://ndlpavranches.fr/nous-contacter/" target="_blank">Contact</a></li>
      <li><a href="https://ndlpavranches.fr/wp-content/uploads/2021/11/Reglement-interieur-2021-2022.pdf" target="_blank">Réglement
          intérieur</a></li>
      <li><a href="https://ndlpavranches.fr/edito/" target="_blank">Edito</a></li>
      <li><a href="https://www.ecoledirecte.com/login?cameFrom=%2FAccueil" target="_blank">EcoleDirecte</a></li>
      <li class="menu">
        <a href="formation.php" class="nav" target="_blank">Nos Formations</a>
        <li><a href="Créer_saisir.html" target="_blank">Ajouter</a></li>
