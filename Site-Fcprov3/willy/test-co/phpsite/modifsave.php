...
<?php
  ...
  $Requete = "UPDATE formation SET CodeForma = '$id', DateDebut = '$date', Duree = '$duree', NbPlace = '$place', HeureDebut = '$heure', NomFormation = '$formation', Presentation = '$desc'  WHERE CodeForma = '$id'" ;
